...
TransactionController.$inject = ['$scope', 'transactionService', 'accountsService', 'categoriesService'];

function TransactionController($scope, transactionService, accountsService, categoriesService) {
